...
<asp:Content ID="Content1" ContentPlaceHolderID="AdminDashboardContentPlaceHolder" runat="server">
    ...
    <div class="form-container">
        ...
        <asp:GridView ID="gvOrders" runat="server" AutoGenerateColumns="False" DataKeyNames="ProductId" OnRowCommand="GridView1_RowCommand" OnRowDeleting="gvProducts_RowDeleting" CssClass="table table-bordered table-striped  table-hover">
            <Columns>
