...
<div class="sn-main-card card">
    <div class="sn-main-content card-body">
        ...
        <form class="">
            <div>
                <label class="form-label">Rating</label><div><span style="cursor: pointer;">
                   </div>
            <div>
                <label class="form-label">Comment</label><textarea name="comment" required="" class="form-control">test</textarea></div>
